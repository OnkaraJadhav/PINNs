'''
Author: Onkar Jadhav
Python script for a PINNs of BE with viscosity
'''
...
def fun_r(t, x, u, u_t, u_x, u_xx):
    ...
    return LAM*(u_t + u * u_x - viscosity * u_xx) # u_t + u * u_x - viscosity * u_xx
...
def init_model(num_hidden_layers=1, num_neurons_per_layer=60):
